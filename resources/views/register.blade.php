                ...
                <div class="container my-5">
                    ...
                    <div class="col-md-6 p-5">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                            class="form-control form-control-lg" name="Sub-district" id="Sub-district" placeholder="กรุณาระบุตำบลหรือแขวงที่ท่านอาศัยอยู่">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control form-control-lg" name="confirm password" id="confirm password" placeholder="กรุณาระบุรหัสผ่านอีกครั้ง">
                        </div>
